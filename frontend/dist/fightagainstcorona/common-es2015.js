...
let CounterService = class CounterService {
    constructor(http) {
        this.http = http;
        this.postUrl = `http://localhost:3000/api`;
        // private postUrl =`api`;
        this.httpOptions = {
...
let PostService = class PostService {
    ...
    getAllPost() {
        return this.http.get(this.postUrl + '/post/get-all-post')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log('fetched post')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('posts', [])));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
            // TODO: send the error to remote logging infrastructure
